...
# Time and environment configuration

@export var seconds_per_minute: float = 1 # 1 detik real = 1 menit game
...
# Scene references and runtime state
...
func advance_minutes(total_minutes: int) -> void:
	...
	for _each_minute in range(total_minutes):
		advance_one_minute()
		day_cycle()
